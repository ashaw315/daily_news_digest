namespace :admin do
  ...
  task fix_user: :environment do
    ...
    password = 'newpassword123'  # Set a new password you'll remember
...
endnamespace :admin do
  ...
  desc "Setup admin via web"
  task setup_web: :environment do
    # Just ensure the task exists for web trigger
    email = 'ashaw315@gmail.com'
